...
|---|---|---|---|---|
| 1 | Monolith (`phase-1-monolith`) | Gallery works end-to-end locally: OTP login via MailHog, upload, albums, heavy process route | in-review — implementation complete, coverage/lint/typecheck + E2E gate still running (see `04-implementation-plan.md`) | `04-implementation-plan.md` |
