...
|---|---|---|---|---|
| 1 | Monolith (`phase-1-monolith`) | Gallery works end-to-end locally: OTP login via MailHog, upload, albums, heavy process route | in-progress | `04-implementation-plan.md` |
